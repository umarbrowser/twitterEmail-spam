...
print '''Created by umar haruna abdullahi known as pyc0d3r\r
umarbrowser20@gmail.com under free public linces'''
...
def main():
    ...
    parser.add_option('-u', dest='handle', type='string', help='speciy twitter handle')
    parser.add_option('-t', dest='tgt', type='string', help='specipy target email')
    ...
    interests = spamTgt.find_interrests()
